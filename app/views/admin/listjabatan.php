              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><a type="button" class="btn btn-warning" href="<?= BASEURL ?>admin/inputupdatejabatan/<?= $x['id'] ?>">Edit</a> | <a type="button" class="btn btn-danger" href="<?= BASEURL ?>admin/deletejabatan/<?= $x['id'] ?>">Hapus</a></td>
                  <?php
                    }
                  ?>
                  </tbody>
